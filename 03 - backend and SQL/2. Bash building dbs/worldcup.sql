...
--
-- Name: games fk_losers; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_losers FOREIGN KEY (winner_id) REFERENCES public.teams(team_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_winners FOREIGN KEY (winner_id) REFERENCES public.teams(team_id) ON DELETE CASCADE;
